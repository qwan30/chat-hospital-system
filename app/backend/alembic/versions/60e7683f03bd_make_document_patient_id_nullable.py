...
def downgrade() -> None:
    ...
    with op.batch_alter_table("patient_permissions", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_patient_permissions_user_patient_scope"), ["user_id", "patient_id", "scope"], unique=False
        )  # noqa: E501
    ...
    with op.batch_alter_table("document_chunks", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_document_chunks_patient_document"), ["patient_id", "document_id"], unique=False
        )  # noqa: E501
        batch_op.alter_column("patient_id", existing_type=sa.CHAR(length=32), nullable=False)
