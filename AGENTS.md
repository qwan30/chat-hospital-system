...
This project is indexed by GitNexus as **chatbot-hospital-system** (2541 symbols, 6778 relationships, 210 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
