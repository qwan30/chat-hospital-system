...
export const citations: Record<string, CitationSource> = {
  ...
  "c-003": {
    ...
    body: "S: Patient reports intermittent palpitations approximately twice weekly, no syncope, no chest pain. O: HR 78, BP 132/78. ECG: AF with controlled ventricular response. A: AF, stable. CHA2DS2-VASc score 4 (age, HTN, prior TIA). P: Continue apixaban 5mg BID. Reinforce DOAC adherence. Echo in 6 months.",
    relevance: 0.82,
  },
  "c-004": {
    id: "c-004",
    ...
    body: "Apixaban renal dose reduction criteria: reduce to 2.5 mg twice daily if any 2 of the following: age ≥80 years, body weight ≤60 kg, or serum creatinine ≥1.5 mg/dL. Dabigatran: avoid if CrCl <30 mL/min. Rivaroxaban: 15 mg daily if CrCl 15-50 mL/min for AF.",
    relevance: 0.74,
  },
  "c-005": {
    id: "c-005",
    ...
    date: "Jun 9, 2026",
    snippet: "Cr 1.1 mg/dL (0.6–1.2). K 4.1. eGFR 62 mL/min/1.73m². Within reference range.",
    body: "Basic metabolic panel. Na 139, K 4.1, Cl 102, HCO3 26, BUN 18, Cr 1.1, Glucose 102. eGFR 62 mL/min/1.73m². All values within reference range. No action required.",
    relevance: 0.6,
  },
  "c-006": {
    id: "c-006",
    ...
    body: "Guideline-directed medical therapy (GDMT) for HFrEF: titrate to maximum tolerated dose of (1) beta-blocker, (2) ACEi/ARB/ARNI, (3) MRA, (4) SGLT2 inhibitor. Reassess clinically every 2 weeks until target reached. Monitor renal function, potassium, and blood pressure at each visit.",
    relevance: 0.91,
  },
};
