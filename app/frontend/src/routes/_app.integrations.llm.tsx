  ...
  return (
    <AppShell>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <MetricCard
          label="Primary uptime"
          value="99.97%"
          delta={{ value: "+0.02pp", positive: true }}
          tone="primary"
        />
        <MetricCard
          label="Avg latency"
          value="820ms"
          delta={{ value: "-40ms", positive: true }}
          tone="ai"
        />
        <MetricCard
      ...
      <Card className="mt-6 p-5 text-sm">
        Routing rules: Cardiology questions → med-large; General chat → med-small; Fallback after 2
        timeouts.
      </Card>
    </AppShell>
  );
