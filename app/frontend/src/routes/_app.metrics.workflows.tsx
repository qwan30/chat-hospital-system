  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="Latency, success, and abandonment across major workflows."
      />
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <MetricCard
          ...
          value="1.8s"
          delta={{ value: "-0.3s", positive: true }}
          tone="primary"
        />
        <MetricCard
          label="P95 latency"
          value="4.6s"
          delta={{ value: "-0.4s", positive: true }}
          tone="primary"
        />
        <MetricCard
          label="Success rate"
      ...
      <Card className="mt-6 p-5">
        <p className="text-sm text-muted-foreground">Workflow breakdown chart (mock).</p>
      </Card>
    </AppShell>
  );
}
