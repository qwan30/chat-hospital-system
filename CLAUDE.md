...
This project is indexed by GitNexus as **chatbot-hospital-system** (1989 symbols, 5286 relationships, 162 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
