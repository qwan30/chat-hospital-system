...
async def seed_synthetic_data(session: AsyncSession) -> None:
    ...
    permissions = [
        ...
        PatientPermission(user_id=DOCTOR_ID, patient_id=PATIENT_ALICE_ID, scope="upload"),
        ...
        PatientPermission(user_id=DOCTOR_ID, patient_id=PATIENT_ELEANOR_ID, scope="upload"),
        ...
        PatientPermission(user_id=NURSE_ID, patient_id=PATIENT_ELEANOR_ID, scope="upload"),
