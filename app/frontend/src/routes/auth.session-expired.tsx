    ...
    <AuthSplitLayout>
      <Card className="p-7">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          For security, your session timed out after 30 minutes of inactivity. Please sign in again
          to continue. Any unsaved chat drafts are preserved on this device.
        </p>
        ...
        <p className="mt-6 rounded-md border bg-muted/40 px-3 py-2 text-xs text-muted-foreground">
          Session ID <span className="font-mono text-foreground">sess-9f3a-71c2</span> · expired
          16:08 UTC · logged in audit trail.
        </p>
      </Card>
    </AuthSplitLayout>
  );
