...
export const traces: Trace[] = [
  {
    ...
    spans: [
      ...
      {
        id: "s3",
        name: "Permission · ABAC eval",
        service: "AccessControl",
        startOffsetMs: 18,
        durationMs: 22,
        status: "ok",
        attributes: { policy: "treatment-relationship", result: "allow" },
      },
      {
        id: "s4",
      ...
      },
      {
        ...
        durationMs: 384,
        status: "ok",
        attributes: { topK: "8", reranked: "true" },
      },
      {
        id: "s6",
        name: "LLM · generate (Qwen2.5-7B)",
        service: "Ollama",
        startOffsetMs: 440,
        durationMs: 1380,
        status: "ok",
  ...
  },
  {
    ...
    spans: [
      ...
      {
        id: "s4",
        name: "LLM · refused (insufficient evidence)",
        service: "Ollama",
        startOffsetMs: 320,
        durationMs: 600,
        status: "warn",
        attributes: { refusal: "insufficient_evidence", citations: "0" },
      },
    ],
  },
];
