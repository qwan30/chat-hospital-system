    ...
    <AppShell>
      ...
      <Card className="p-6 space-y-4">
        ...
        <div className="flex gap-2 justify-end">
          <Button variant="outline" onClick={() => toast.error("Request denied (mock)")}>
            Deny
          </Button>
          <Button onClick={() => toast.success("Approved with 24h scope (mock)")}>
            Approve · 24h
          </Button>
          <Button variant="default" onClick={() => toast.success("Approved with 7d scope (mock)")}>
            Approve · 7d
          </Button>
        </div>
      </Card>
