    ...
    <div className="flex flex-col items-center p-4 bg-bg-surface-tint rounded-xl border border-border-subtle">
      <div className="relative w-24 h-24 mb-2">
        <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
          <circle cx="18" cy="18" r="14" fill="none" stroke="var(--color-border-subtle)" strokeWidth="4" />
          <circle cx="18" cy="18" r="14" fill="none" stroke="var(--color-primary-500)" strokeWidth="4" strokeDasharray={88 * pct / 100 + " " + 88 * (100 - pct) / 100} strokeLinecap="round" />
        </svg>
