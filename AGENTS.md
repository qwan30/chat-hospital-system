...
This project is indexed by GitNexus as **chat-hospital-system** (9898 symbols, 16952 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
