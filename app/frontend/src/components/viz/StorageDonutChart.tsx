  ...
  return (
    <div className="flex flex-col items-center p-6 bg-bg-surface-tint rounded-xl border border-border-subtle">
      <div className="relative w-28 h-28 mb-3">
        <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90"><circle cx="18" cy="18" r="14" fill="none" stroke="var(--color-border-subtle)" strokeWidth="3" /><circle cx="18" cy="18" r="14" fill="none" stroke="var(--color-primary-500)" strokeWidth="3" strokeDasharray={(87.96 * pct / 100).toFixed(1) + " " + (87.96 * (100 - pct) / 100).toFixed(1)} strokeLinecap="round" /></svg>
