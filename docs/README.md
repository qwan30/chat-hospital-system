...
- `02_process_bpmn_use_case.md`
- `03_prd_srs_requirements.md`
- `04_ui_ux_design_package.md`
- `05_system_architecture_sdd.md`
- `06_database_api_integration.md`
- `07_deployment_infrastructure_plan.md`
...
- `design/document-notion-lite.md`

Run frontend commands from `app/frontend`, for example `npm run dev`, `npm run build`, `npm run lint`, and `npm run typecheck`.
