...
This project is indexed by GitNexus as **chat-hospital-system** (10993 symbols, 12996 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
