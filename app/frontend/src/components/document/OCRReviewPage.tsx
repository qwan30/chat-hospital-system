...
interface OCRReviewProps { documentTitle: string; ocrConfidence: number; sections: { text: string; confidence: number }[]; }

export function OCRReviewPage({ documentTitle, ocrConfidence, sections }: OCRReviewProps) {
  return (
