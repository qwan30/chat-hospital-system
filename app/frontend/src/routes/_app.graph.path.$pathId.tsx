...
function Page() {
  ...
  return (
    <AppShell>
      <PageHeader title={`Reasoning path ${pathId}`} description="Why the model connected these facts." />
      <Card className="p-5"><ol className="space-y-3 text-sm list-decimal pl-5">
