...
export function UploadDropzone({ onFilesSelected }: UploadDropzoneProps) {
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-center py-10 px-6 border-2 border-dashed border-border-default rounded-xl bg-bg-surface-tint hover:border-primary-300 hover:bg-primary-50/50 transition-colors">
