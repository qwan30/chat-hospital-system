    ...
    async def document_graph(self, document: Document, current_user: User, filters: GraphFilters) -> DocumentGraphRead:
        ...
        mention_stmt = (
            ...
            .where(
                ...
                DocumentChunk.document_id == GraphMention.document_id,
                DocumentChunk.generation_id == GraphMention.generation_id,
                DocumentChunk.revision_set_id == GraphMention.revision_set_id,
                DocumentChunk.page_revision_id == GraphMention.page_revision_id,
                DocumentChunk.deleted_at.is_(None),
                DocumentPageRevision.status == "approved",
        ...
        assertion_stmt = (
            ...
            .where(
                ...
                DocumentChunk.id.in_(allowed_chunk_ids),
                DocumentChunk.document_id == GraphRelationEvidence.document_id,
                DocumentChunk.generation_id == GraphRelationEvidence.generation_id,
                DocumentChunk.revision_set_id == GraphRelationEvidence.revision_set_id,
                DocumentChunk.page_revision_id == GraphRelationEvidence.page_revision_id,
                DocumentChunk.deleted_at.is_(None),
                DocumentPageRevision.status == "approved",
                DocumentPageRevision.confidence.is_not(None),
                DocumentPageRevision.confidence >= filters.min_confidence,
