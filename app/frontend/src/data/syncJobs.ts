...
export const dlqRecords: DlqRecord[] = [
  {
    ...
    recordId: "LR-99281",
    error: "Missing required field: reference_range",
    attempts: 3,
    lastAttempt: "2026-06-12T15:30:00Z",
  },
  {
    id: "dlq-002",
    source: "HMS · Labs",
    recordType: "LabResult",
    recordId: "LR-99283",
    error: "Unknown LOINC code 99999-9",
    attempts: 3,
    lastAttempt: "2026-06-12T15:30:00Z",
  },
  {
    ...
    recordType: "Document",
    recordId: "DOC-44120",
    error: "Empty document body returned by HMS API",
    attempts: 2,
    lastAttempt: "2026-06-12T14:00:00Z",
  },
  {
    id: "dlq-004",
    source: "HMS · Medications",
    ...
    attempts: 5,
    lastAttempt: "2026-06-12T11:14:00Z",
  },
];
